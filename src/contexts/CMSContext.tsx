...
const defaultPortfolioItems: PortfolioItem[] = [
  ...
  },
  {
    _id: '22',
    _id: '24',
    title: 'PHARO FOUNDATION - SOMALILAND & ETHIOPIA',
    description: 'A selection of projects in Somaliland and Ethiopia. Director of Photography: Fitsum Beza.',
    videoUrl: 'https://youtu.be/_XH-CFEuTe4?si=FycK71BaC2G_j18n',
    coverImage: 'https://img.youtube.com/vi/_XH-CFEuTe4/maxresdefault.jpg',
    category: 'documentaries',
    priority: 3,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Director of Photography: Fitsum Beza.',
    videoUrl: 'https://youtu.be/uDvootlTA00?si=o5mfznm9UrcY_0Ew',
    coverImage: 'https://img.youtube.com/vi/uDvootlTA00/maxresdefault.jpg',
    category: 'documentaries',
    priority: 4,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'CALL ME',
    description: '',
    videoUrl: 'https://youtu.be/cEYTjwhcNNc?si=i1FtOPw5mez_eUCq',
  ...
  },
  {
    ...
    title: 'MIMI',
    description: '',
    videoUrl: 'https://youtu.be/bgDcrroWK5Q?si=BnVO3N57BiGvqhjc',
    coverImage: 'https://img.youtube.com/vi/bgDcrroWK5Q/maxresdefault.jpg',
    category: 'music-videos',
    priority: 7,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'AMARTII KOO',
    description: '',
    videoUrl: 'https://youtu.be/ect8QI3hPP8?si=EbwIdrQwd50d2Rol',
    coverImage: 'https://img.youtube.com/vi/ect8QI3hPP8/maxresdefault.jpg',
    category: 'music-videos',
    priority: 8,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'DARROO',
    description: '',
    videoUrl: 'https://youtu.be/t5yMzJeos9s?si=bhsmCWLYSJAZSvaA',
    coverImage: 'https://img.youtube.com/vi/t5yMzJeos9s/maxresdefault.jpg',
    category: 'music-videos',
    priority: 9,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'SHONKOOREE',
    description: '',
    videoUrl: 'https://youtu.be/ozr2Pn7MB0s?si=xAsYl9hd8NvzpeSK',
    coverImage: 'https://img.youtube.com/vi/ozr2Pn7MB0s/maxresdefault.jpg',
    category: 'music-videos',
    priority: 10,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'KIKI',
    description: '',
    videoUrl: 'https://youtu.be/J_vIXJWLBC4?si=DhBeZcqzjOTD_lf3',
    coverImage: 'https://img.youtube.com/vi/J_vIXJWLBC4/maxresdefault.jpg',
    category: 'music-videos',
    priority: 11,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'GADAA MALEE',
    description: '',
    videoUrl: 'https://youtu.be/XsqGg9ia4xU?si=hoTmJQt5vUGiMAPu',
    coverImage: 'https://img.youtube.com/vi/XsqGg9ia4xU/maxresdefault.jpg',
    category: 'music-videos',
    priority: 13,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'HARAR',
    description: '',
    videoUrl: 'https://youtu.be/jEg4ZotZoEs?si=55a1O9Bcl0kvwzfo',
    coverImage: 'https://img.youtube.com/vi/jEg4ZotZoEs/maxresdefault.jpg',
    category: 'music-videos',
    priority: 14,
    published: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    title: 'KANA JEDHIIN',
    description: '',
    videoUrl: 'https://youtu.be/seL68zV1wWk?si=Dom1vJyaQI6KOdoN',
    coverImage: 'https://img.youtube.com/vi/seL68zV1wWk/maxresdefault.jpg',
    category: 'music-videos',
    priority: 16,
    published: true,
    createdAt: new Date().toISOString(),

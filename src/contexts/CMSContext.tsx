...
const defaultPortfolioItems: PortfolioItem[] = [
  // Documentaries
  { _id: 'd1', title: 'DOBO', description: 'This documentary was filmed in the southern part of Ethiopia and premiered at the European Film Festival, with a special screening in Cannes, France.', videoUrl: 'https://youtu.be/zexHLtFerjQ?si=esaOkqFdF559kWHo', coverImage: 'https://res.cloudinary.com/dhb7y3wk3/image/upload/v1771928350/dobo_1po_jbhe8m.jpg', category: 'documentaries', priority: 1, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'd2', title: 'THE COFFEE PROJECT', description: 'A visual journey through Ethiopia\'s ancient coffee culture — from highland farm to city cup.', videoUrl: 'https://youtu.be/XOLherLZue8?si=x_Fkl72eVz2t7xQt', coverImage: 'https://res.cloudinary.com/dcj3zekyw/image/upload/q_auto/f_auto/v1779229933/DSC05581_auuds9.jpg', category: 'documentaries', priority: 2, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'd3', title: 'PHARO FOUNDATION - SOMALILAND & ETHIOPIA', description: 'A selection of projects in Somaliland and Ethiopia. Director of Photography: Fitsum Beza.', videoUrl: 'https://youtu.be/_XH-CFEuTe4?si=FycK71BaC2G_j18n', coverImage: 'https://img.youtube.com/vi/_XH-CFEuTe4/maxresdefault.jpg', category: 'documentaries', priority: 3, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'd4', title: 'NATIONAL PALACE', description: 'Director of Photography: Fitsum Beza.', videoUrl: 'https://youtu.be/uDvootlTA00?si=o5mfznm9UrcY_0Ew', coverImage: 'https://img.youtube.com/vi/uDvootlTA00/maxresdefault.jpg', category: 'documentaries', priority: 4, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'd5', title: 'BEYNOUNA VILLAGE - ETHIOPIA', description: 'A documentary capturing the beauty and life of Beynouna Village in Ethiopia. Director of Photography: Fitsum Beza.', videoUrl: 'https://youtu.be/4z-by0jVjYo?si=qCxVffK7LxoLnmi2', coverImage: 'https://img.youtube.com/vi/4z-by0jVjYo/maxresdefault.jpg', category: 'documentaries', priority: 5, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'd6', title: 'VISIT OROMIA-BORENA', description: 'A cinematic journey through the breathtaking landscapes and culture of Oromia-Borena.', videoUrl: 'https://youtu.be/agCiBLPmgjo?si=JS-fW62fG0Z8NrN3', coverImage: 'https://img.youtube.com/vi/agCiBLPmgjo/maxresdefault.jpg', category: 'documentaries', priority: 6, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  // Music Videos
  { _id: 'mv1', title: 'GUMAYE', description: 'A vibrant visual journey through rhythm and culture.', videoUrl: 'https://youtu.be/NDWqiLS5KVM?si=uiVeu6LaWBtzbbmK', coverImage: 'https://img.youtube.com/vi/NDWqiLS5KVM/maxresdefault.jpg', category: 'music-videos', priority: 1, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv2', title: 'TOXIC LOVE', description: 'A story of love and danger.', videoUrl: 'https://www.youtube.com/watch?v=LI1UDweTrUg', coverImage: 'https://img.youtube.com/vi/LI1UDweTrUg/maxresdefault.jpg', category: 'music-videos', priority: 2, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv3', title: 'SHEGER', description: 'City lights and urban rhythms.', videoUrl: 'https://www.youtube.com/watch?v=MHRhc0g32Ko', coverImage: 'https://img.youtube.com/vi/MHRhc0g32Ko/maxresdefault.jpg', category: 'music-videos', priority: 3, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv4', title: 'BOONAA BONNAA', description: 'Rhythm and passion combined.', videoUrl: 'https://youtu.be/Kku9RFIiqfc?si=z7ADNJor76wLG_ws', coverImage: 'https://img.youtube.com/vi/Kku9RFIiqfc/maxresdefault.jpg', category: 'music-videos', priority: 4, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv5', title: 'NEY MELA', description: 'A celebration of culture and music.', videoUrl: 'https://youtu.be/00cQUP4PxPs?si=OEXQMhWN5y4bHJhm', coverImage: 'https://img.youtube.com/vi/00cQUP4PxPs/maxresdefault.jpg', category: 'music-videos', priority: 5, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv6', title: 'MARARTUU', description: '', videoUrl: 'https://youtu.be/F1cfzTGxcCs?si=l1Elwl8uPVpeVnTR', coverImage: 'https://img.youtube.com/vi/F1cfzTGxcCs/maxresdefault.jpg', category: 'music-videos', priority: 6, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv7', title: 'CALL ME', description: '', videoUrl: 'https://youtu.be/cEYTjwhcNNc?si=i1FtOPw5mez_eUCq', coverImage: 'https://img.youtube.com/vi/cEYTjwhcNNc/maxresdefault.jpg', category: 'music-videos', priority: 7, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv8', title: 'MIMI', description: '', videoUrl: 'https://youtu.be/bgDcrroWK5Q?si=BnVO3N57BiGvqhjc', coverImage: 'https://img.youtube.com/vi/bgDcrroWK5Q/maxresdefault.jpg', category: 'music-videos', priority: 8, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv9', title: 'AMARTII KOO', description: '', videoUrl: 'https://youtu.be/ect8QI3hPP8?si=EbwIdrQwd50d2Rol', coverImage: 'https://img.youtube.com/vi/ect8QI3hPP8/maxresdefault.jpg', category: 'music-videos', priority: 9, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv10', title: 'DARROO', description: '', videoUrl: 'https://youtu.be/t5yMzJeos9s?si=bhsmCWLYSJAZSvaA', coverImage: 'https://img.youtube.com/vi/t5yMzJeos9s/maxresdefault.jpg', category: 'music-videos', priority: 10, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv11', title: 'SHONKOOREE', description: '', videoUrl: 'https://youtu.be/ozr2Pn7MB0s?si=xAsYl9hd8NvzpeSK', coverImage: 'https://img.youtube.com/vi/ozr2Pn7MB0s/maxresdefault.jpg', category: 'music-videos', priority: 11, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv12', title: 'KIKI', description: '', videoUrl: 'https://youtu.be/J_vIXJWLBC4?si=DhBeZcqzjOTD_lf3', coverImage: 'https://img.youtube.com/vi/J_vIXJWLBC4/maxresdefault.jpg', category: 'music-videos', priority: 12, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv13', title: 'GADAA MALEE', description: '', videoUrl: 'https://youtu.be/XsqGg9ia4xU?si=hoTmJQt5vUGiMAPu', coverImage: 'https://img.youtube.com/vi/XsqGg9ia4xU/maxresdefault.jpg', category: 'music-videos', priority: 13, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv14', title: 'HARAR', description: '', videoUrl: 'https://youtu.be/jEg4ZotZoEs?si=55a1O9Bcl0kvwzfo', coverImage: 'https://img.youtube.com/vi/jEg4ZotZoEs/maxresdefault.jpg', category: 'music-videos', priority: 14, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv15', title: 'SAAMBEE', description: '', videoUrl: 'https://youtu.be/x-3hFZM-RmY?si=CdwkVvTW-QR-sBYC', coverImage: 'https://img.youtube.com/vi/x-3hFZM-RmY/maxresdefault.jpg', category: 'music-videos', priority: 15, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv16', title: 'KANA JEDHIIN', description: '', videoUrl: 'https://youtu.be/seL68zV1wWk?si=Dom1vJyaQI6KOdoN', coverImage: 'https://img.youtube.com/vi/seL68zV1wWk/maxresdefault.jpg', category: 'music-videos', priority: 16, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv17', title: 'INSTRUMENTAL', description: '', videoUrl: 'https://youtu.be/BuViNxURvTg?si=6yI2DQYE27cmJR_E', coverImage: 'https://img.youtube.com/vi/BuViNxURvTg/maxresdefault.jpg', category: 'music-videos', priority: 17, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv18', title: 'SIRRAA TOLA', description: '', videoUrl: 'https://youtu.be/iruH02Byrrw?si=q_qxw9h-ITilRmD5', coverImage: 'https://img.youtube.com/vi/iruH02Byrrw/maxresdefault.jpg', category: 'music-videos', priority: 18, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: 'mv19', title: 'MICHUU', description: '', videoUrl: 'https://youtu.be/AMNMOiH6t4w?si=yq4yY2cVkBdREBIA', coverImage: 'https://img.youtube.com/vi/AMNMOiH6t4w/maxresdefault.jpg', category: 'music-videos', priority: 19, published: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];
